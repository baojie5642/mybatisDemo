...
import springMybatis.service.IAccountService;
...
public class TestAccountService {
	...
	public static void setUp() {
		...
		accountService = (IAccountService) FactoryManager.getBean("accountService");
	}
	...
	public TestAccountService(int id, String username) {
		this.idParam = id;
	...
	public void testFindByName() {
		System.out.println("-------------");
		Account account1 = accountService.findByName(usernameParam);
	...
	public void testFindById() {
		System.out.println("************");
		Account account1  = accountService.findById(idParam);
		System.out.println(account1);
